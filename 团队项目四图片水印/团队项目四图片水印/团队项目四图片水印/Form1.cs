...
namespace 团队项目四图片水印
{
    public partial class Form1 : Form
    {
        ...
        int PicCount = 0;
        int WaterMarkLocationX=200;
        int WaterMarkLocationY=150;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ofd.InitialDirectory = @"C:\桌面设计\团队项目四图片水印\团队项目四图片水印\imgs";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            ofd2.InitialDirectory = @"C:\桌面设计\团队项目四图片水印\团队项目四图片水印\WaterMark";
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            ...
            else
            {
               label1.Visible = false;
                ...
                new float[] {0, 0, 0, 0, 1}};
                opacity = float.Parse(trackBar1.Value.ToString()) * 0.1f;
               ...
               /*Bitmap bmp = new Bitmap(imgWaterMark);
                ...
                if (ofd.FileNames.Length == 1)
                {
                    ...
                    Bitmap imgO = new Bitmap(imgOrigin);
                    g = Graphics.FromImage(imgO);
                    g.DrawImage(imgWaterMark, new Rectangle(WaterMarkLocationX, WaterMarkLocationY, imgWaterMark.Width, imgWaterMark.Height), 0, 0, imgWaterMark.Width, imgWaterMark.Height, GraphicsUnit.Pixel, attributes);
                    pictureBox1.BackgroundImage = imgO;
        ...
        private void WaterMarkLocX_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                WaterMarkLocationX = Convert.ToInt32(WaterMarkLocX.Text);
                SendKeys.Send("{tab}");
        ...
        private void WaterMarkLocY_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                WaterMarkLocationY = Convert.ToInt32(WaterMarkLocY.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.FileNames.Length == 1)
            {
                string path = @"C:\桌面设计\团队项目四图片水印\团队项目四图片水印\imgAfter";
            ...
            else
            {
                ...
                foreach (string fileName in ofd.FileNames)
                {
                    ...
                    string path = @"C:\桌面设计\团队项目四图片水印\团队项目四图片水印\批量保存After";
